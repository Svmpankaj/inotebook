...
router.post('/createuser',
    ...
    body('password').isLength({ min: 3 }).withMessage('Password must be atleast 5 characters'),
    async (req, res) => {
...
// ROUTE 3:  Get loggendin  User Details using: POST "/api/auth/getuser". login required
